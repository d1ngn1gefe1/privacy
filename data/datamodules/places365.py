...
class Places365DataModule(BaseDataModule):
  ...
  def prepare_data(self):
    ...
    Places365(dir_places365, split='train-standard', download=not osp.exists(osp.join(dir_places365, 'data_large_standard')))
    Places365(dir_places365, split='val', download=not osp.exists(osp.join(dir_places365, 'val_large')))
