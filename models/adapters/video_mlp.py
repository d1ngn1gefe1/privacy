from pytorchvideo.layers import Mlp as VideoMlp
import timm
import torch
...
class VideoMlpAdapter(VideoMlp):
  ...
  def convert_adapter(cls, module):
    ...
    if isinstance(module, mlp_module):
      ...
      bias_on = module.fc1.bias  # TODO: Figure out why not in kargs
      res = cls(in_features, hidden_features=hidden_features, out_features=out_features, act_layer=act_layer, dropout_rate=dropout_rate)
